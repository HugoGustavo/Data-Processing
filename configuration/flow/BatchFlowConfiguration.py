...
class BatchFlowConfiguration(object):
    def __init__(self, from_bucket=None, to_bucket=None, company=None, region=None, business_unit=None,
    ...
    def get_from_bucket(self):
        result = copy.deepcopy(self.__from_bucket)
        return result

    def get_to_bucket(self):
        result = copy.deepcopy(self.__to_bucket)
        return result
    ...
    def __str__(self):
        result = '['
        result = result + 'from_bucket=' + str(self.__from_bucket) + ","
        result = result + 'to_bucket=' + str(self.__to_bucket) + ","
