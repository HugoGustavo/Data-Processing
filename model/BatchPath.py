...
class BatchPath(object):
    def __init__(self, bucket=None, company=None, region=None, business_unit=None, vice_presidency=None, domain=None,
                 subdomain=None, context=None, pipeline=None, data_source=None, year=None, month=None, day=None,
                 execution=None, filename=None):
    ...
    def is_empty(self):
        return ObjectUtil.is_none(self.__bucket) \
    ...
    def __str__(self):
        ...
        if StringUtil.is_not_empty(self.__filename):
            result = result + str(self.__filename)
